...
replace (
	cosmossdk.io/core => cosmossdk.io/core v0.11.3 // proper SDK v50 version
	...
	github.com/strangelove-ventures/tokenfactory/types => ../
)
...
require (
	...
	github.com/strangelove-ventures/tokenfactory/third_party/docker-client v0.0.0 // indirect
...
replace github.com/cosmos/interchaintest/v10 => ../third_party/interchaintest-v10

replace github.com/ethereum/go-ethereum/trie/utils => ./compat/geth-trie-utils

replace github.com/strangelove-ventures/tokenfactory/third_party/docker-client => ../third_party/docker-client-v28
